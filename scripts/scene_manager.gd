...
var scente_transition_screen = preload("res://ui/screen_transition/scene_transition_screen.tscn")
...
func transition_to_scene(level:String):
	...
	if scene_path != null:
		var scene_transition_screen_instance = scente_transition_screen.instantiate()
