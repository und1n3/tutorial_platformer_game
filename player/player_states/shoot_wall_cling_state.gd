...
func on_physics_process(delta : float):
	...
	if direction > 0 and wall_cling_direction == Vector2.ZERO: # wall_cling_direction has not been yet defined
...
func enter():
	muzzle.position = Vector2(21,-26) # When player is standing facing the right
