...
@export var hold_gun_time : float = 1.1
...
func enter():
	muzzle.position = Vector2(4,-42) # When player is standing facing up
...
func gun_shooting():
	...
	bullet_instance.direction = -1 # to move the bullet upwards
